...
if (Site::getUtilisateur()) {
    if (Site::getUtilisateur()->getStatut() == "client") {
        ...
        <ul id="css3menu1" class="topmenu">
            <li class="topmenu"><a onclick="getController({'controller' : 'accueil'});" style="height:24px;line-height:24px;"><img src="css/css3menu1/256base-home-over.png" alt="Accueil"/>Accueil</a></li>
