 ...
 class UTILISATEUR
{
	...
	public function inserUti($p_log, $p_mail, $p_mdp, $p_statut){
		...
		$query="INSERT INTO utilisateur (uti_login ,uti_statut, uti_mail, uti_mdp, uti_nom, uti_prenom, uti_ddn, uti_adresse, uti_cp, uti_ville, uti_tel, uti_presentation, uti_dateInscription) VALUES ('".$p_log."','".$p_statut."','".$p_mail."','".$p_mdp."','','','','','','','','','".$dateInscription."')";
		mysql_query($query);
		// echo $query;
	}
// accesseurs
	 ...
	 public function getMdp(){return $this->m_mdp; }
     public function getNom(){return $this->m_nom; }
	 public function getPrenom(){return $this->m_prenom; }
	 public function getDdn(){return $this->m_ddn; }
	 public function getAdr(){return $this->m_adresse; }
	 public function getCp(){return $this->m_cp; }
	 public function getVille(){return $this->m_ville; }
	 public function getTel(){return $this->m_tel; }
	 public function getMail(){return $this->m_mail; }
	 public function getStatut(){return $this->m_statut; }
