 ...
 class PROJET
{
	...
	public function inserProjet($p_libelle, $p_description, $p_budget, $p_delai){
		...
		$query="INSERT INTO projet (projet_libelle ,projet_description, projet_budget, projet_delai, projet_dateCreation) VALUES ('".$p_libelle."','".$p_description."','".$p_budget."','".$p_delai."','".$dateCreation."')";
		mysql_query($query);
		// echo $query;
	}
// accesseurs
     public function getCode(){return $this->m_id; }
	 public function getLibelle(){return $this->m_libelle; }
	 public function getDescription(){return $this->m_description; }
     public function getBudget(){return $this->m_budget; }
	 public function getDelai(){return $this->m_delai; }
	 public function getDateCreation(){return $this->m_dateCreation; }
